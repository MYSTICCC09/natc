    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="tracking.html"> Tracking</a></p>
            </div>
        </div>
    </div>
</section>
...
//                        echo "id: " . $row["id"]. " - Name: " . $row["firstname"]. " " . $row["lastname"]. "<br>";
        ...
        $sql = "SELECT c.driver_fullname, d.model, d.plate_no, a.status FROM natc_assign_booking a
                ...
                <div>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <?php if($res2['status'] == 1){?>
                                <td>Assigned</td>
                            <?php }?>
                            <?php if($res2['status'] == 2){?>
                                <td>Picked Up</td>
                            <?php }?>
                            <?php if($res2['status'] == 3){?>
                                <td>Completed</td>
                            <?php }?>
                            <?php if($res2['status'] == 4){?>
                                <td>Cancelled</td>
                            <?php }else{?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $res2['driver_fullname']?></td>
                        </tr>
                        <tr>
                            <th scope="row">Plate No.:</th>
                            <td><?php echo $res2['plate_no']?></td>
                        </tr>
                    </table>
                </div>

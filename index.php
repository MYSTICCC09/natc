				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-6 col-md-6">
                            <h4 class="text-white ">Do you need Airport Taxi?</h4>
                            <div class="">
						...
						<div class="col-lg-4 col-md-6 header-right" style="background: #bde6e2 !important;">
                            <img src="img/natclogo.png" class="img-fluid" alt="" width="150"/>
                            <br/>
                            <br/>
							<h4 class="pb-30">Airport Transport Online!</h4>
							<form class="form" method="post" action="booking.php">
							    <div class="from-group">
							    	<input class="form-control txt-field" required type="text" name="name" placeholder="Your name"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'">
							    	...
							    	<input class="form-control txt-field" required type="tel" name="phone" placeholder="Phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone number'">
							    </div>								
							    <div class="form-group">
							       	<div class="default-select" id="default-select">
										<select name="pickup" required>
											<option value="" disabled selected hidden>Pick-Up Airport</option>
							    ...
							    <div class="form-group">
									<div class="input-group dates-wrap">                                              
										<input id="datepicker2" required name="date" class="dates form-control"  placeholder="Pick Up Date" type="text">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 single-service">
							...
							<a href="#"><h4>Vision statement </h4></a>
							<p>
                                To establish the transport as RELIABLE Transport in
                                the entire airport transport sector.
							</p>
						</div>
						<div class="col-lg-6 single-service">
							<span class="lnr lnr-briefcase"></span>
							<a href="#"><h4>Mission statement</h4></a>
							<p>
                                To offer customer: EFFICIENT, HASSLE-FREE, REASONABLE PRICE, SATISFACTORY of our client
							</p>
						</div>
					</div>
				</div>	
				...
				<div class="container">
					...
					<div class="row align-items-center section-gap">
						<div class="col-lg-8">
							...
							<p>
                                Providing market-leading standards in the field of vehicle rental services, Nasugbu Airport Transport Corp. offers Sedan, AUV, SUV and Van for daily rental or to meet corporate requirements. Customers can be confident of finding a tailor-made solution to their needs and budgets.
							</p>
						</div>
